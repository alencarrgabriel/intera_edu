...
export class ProxyController {
  ...
  private resolveService(path: string): { service: string; servicePath: string } | null {
    const routes: Array<{ prefix: string; service: string }> = [
      ...
      { prefix: '/disciplines', service: 'feed' },
      { prefix: '/groups', service: 'feed' },
      { prefix: '/materials', service: 'feed' },
      { prefix: '/bookmarks', service: 'feed' },
      { prefix: '/stories', service: 'feed' },
      { prefix: '/tags', service: 'feed' },
